...
if(p==null){
	response.sendRedirect("http://localhost:8080/OBAIDASalma/authentification");
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
           <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" id="adds">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">View the Books</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" aria-expanded="false" aria-controls="ui-basic">
                <i class="menu-icon typcn typcn-coffee"></i>
                <span class="menu-title">Reserve a Book</span>
        ...
        <div class="main-panel">
              ...
              <div class="col-md-12">
                <div class="page-header-toolbar">
                  <div class="btn-group toolbar-item" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary">11/05/2021 - 25/05/2021</button>
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">  <a href="https://www.bootstrapdash.com/bootstrap-admin-template/" target="_blank">FSBM university </a> from fsbm.com</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
