      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="livre" method="post">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName1" name="isbn" placeholder="Isbn">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail3" name="type" placeholder="Type">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword4">Description</label>
            <input type="text" class="form-control" id="exampleInputPassword4" name="description" placeholder="Description">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword4">Year of publication</label>
            <input type="text" class="form-control" id="exampleInputPassword4" name="yof" placeholder="Year Of Publication">
          </div>
          <div class="form-group">
          ...
          <button type="submit" class="btn btn-success mr-2 form-control btn-lg">Add Your Book</button>
